...
public:
    ...
    void set_end_timestamp(uint64_t end_timestamp){txn->end_timestamp=end_timestamp;}
    ...
    // For MVOCC
    std::set<RowVersionEntry*> readset;
    std::set<RowVersionEntry*> writeset;
    std::set<RowVersionEntry*> commitset;
